...
export default function Dashboard() {
  ...
  const dueThisWeek = tasks.filter(t => t.due_date && t.due_date <= weekFromNow && t.due_date >= today).length;
  ...
  const statusData = [
    ...
    { name: 'In Progress', value: statusCounts['in-progress'], color: 'hsl(var(--status-in-progress))' },
    { name: 'Completed', value: statusCounts.completed, color: 'hsl(var(--status-completed))' },
  ];
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex items-center justify-between rounded-lg border p-3">
              ...
              <span className="text-2xl font-bold text-warning">{dueToday}</span>
            </div>
            <div className="flex items-center justify-between rounded-lg border p-3">
              <span className="font-medium">Due This Week</span>
              <span className="text-2xl font-bold text-info">{dueThisWeek}</span>
            </div>
            <div className="flex items-center justify-between rounded-lg border p-3">
